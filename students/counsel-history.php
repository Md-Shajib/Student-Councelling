...
?>
  ...
  <html lang="en">
    <head>
      ...
      <title>Student Counsel History</title>
  ...
  <?php include("includes/sidebar.php");?>
        ...
        <section id="main-content">
            <section class="wrapper">
              <h3><i class="fa fa-angle-right"></i>Your Counsel Hstory</h3>
            <div class="row mt">
              <div class="col-lg-12">
                        <div class="content-panel">
                            <section id="unseen">
                              <table class="table table-bordered table-striped table-condensed">
                                ...
                                <tbody>
    <?php $query=mysqli_query($bd, "select * from tblstudents where userId='".$_SESSION['id']."'");
  ...
  <?php } ?>
                                    <td align="center">
                                    <a href="counsel-details.php?cid=<?php echo htmlentities($row['complaintNumber']);?>">
