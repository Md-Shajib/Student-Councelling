      ...
      <?php include('includes/sidebar.php');?>
        <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Counsel Details</h3>
            <hr />

            <?php $query=mysqli_query($bd, "select tblstudents.*,category.categoryName as catname from tblstudents join category on category.id=tblstudents.category where userId='".$_SESSION['id']."' and complaintNumber='".$_GET['cid']."'");
            while($row=mysqli_fetch_array($query))
            {?>
          	  <div class="row mt">
                <label class="col-sm-2 col-sm-2 control-label"><b>Counsel Number : </b></label>
          		  <div class="col-sm-4">
              ...
              <div class="row mt">
                <label class="col-sm-2 col-sm-2 control-label"><b>Counsel Type :</b></label>
                <div class="col-sm-4">
              ...
              <div class="row mt">
                <label class="col-sm-2 col-sm-2 control-label"><b>Nature of Counsel :</b></label>
                <div class="col-sm-4">
              ...
              <div class="row mt">
                <label class="col-sm-2 col-sm-2 control-label"><b>Counsel Details </label>
                <div class="col-sm-10">
              ...
              <?php 
              $ret=mysqli_query($bd, "select studentremark.remark as remark,studentremark.status as sstatus,studentremark.remarkDate as rdate from studentremark join tblstudents on tblstudents.complaintNumber=studentremark.complaintNumber where studenttremark.complaintNumber='".$_GET['cid']."'");
              while($rw=mysqli_fetch_array($ret)){ ?>
                ...
                <div class="row mt">
                  ...
                  <div class="col-sm-10">
                    <?php 
                    echo  htmlentities($rw['remark']); ?> &nbsp;&nbsp; <b>Remark Date: <?php echo  htmlentities($rw['rdate']); ?></b>
                  </div>
                </div> 
