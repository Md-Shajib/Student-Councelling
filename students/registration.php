...
if(isset($_POST['submit']))
{
	...
	$status=1;
	$query=mysqli_query($bd, "insert into students(fullName,userEmail,password,contactNo,status) values('$fullname','$email','$password','$contactno','$status')");
...
<html lang="en">
  <head>
    ...
    <title>Counsel | Student Registration</title>
