<?php
  ...
  if(strlen($_SESSION['login'])==0){ 
    ...
    if(isset($_POST['submit'])){
      $sql = mysqli_query($bd, "SELECT password FROM  students where password='".md5($_POST['password'])."' && userEmail='".$_SESSION['login']."'");
      $num = mysqli_fetch_array($sql);
      if($num>0){
        $con=mysqli_query($bd, "UPDATE students set password='".md5($_POST['newpassword'])."', updationDate='$currentTime' where userEmail='".$_SESSION['login']."'");
...
<head>
    ...
    <title>Counsel | User Change Password</title>
