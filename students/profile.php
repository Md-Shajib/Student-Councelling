...
if(strlen($_SESSION['login'])==0){ 
  ...
  if(isset($_POST['submit'])){
    ...
    $regNo=$_POST['regNo'];
    $query=mysqli_query($bd, "update students set fullName='$fname',contactNo='$contactno',address='$address',State='$state',country='$country',regNo='$regNo' where userEmail='".$_SESSION['login']."'");
    if($query){
            ...
            <section class="wrapper">
                ...
                <div class="row mt">
                    ...
                    {?>
                            ...
                            <?php }?>
                            <?php $query=mysqli_query($bd, "select * from students where userEmail='".$_SESSION['login']."'");
                    ...
                    { ?>
                            ...
                            <form class="form-horizontal style-form" method="post" name="profile">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">Reg No.</label>
                                    <div class="col-sm-4">
                                        <input type="text" name="regNo" maxlength="6" required="required"
                                            value="<?php echo htmlentities($row['regNo']);?>" class="form-control">
                                    </div>
