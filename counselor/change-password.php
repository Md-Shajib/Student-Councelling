...
if(strlen($_SESSION['alogin'])==0){	
	...
	if(isset($_POST['submit'])){
		$sql=mysqli_query($bd, "SELECT password FROM  db_admin where password='".md5($_POST['password'])."' && username='".$_SESSION['alogin']."'");
		$num=mysqli_fetch_array($sql);
		if($num>0){
 			$con=mysqli_query($bd, "UPDATE db_admin set password='".md5($_POST['newpassword'])."', updationDate='$currentTime' where username='".$_SESSION['alogin']."'");
